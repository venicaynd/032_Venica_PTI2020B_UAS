   ...
   <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
		  ...
		  if(!file_exists(DB)){
			  saveTxt(DB,"ID#Kategori#product_title#product_image#product_price#product_qty#cat_title#brand_title".PHP_EOL,'a');
			}
			...
			foreach($loadDB as $data){
				...
				if($i==0){}else{
					...
					$ID = $expData[0];
					$Kategori = $expData[1];
					$product_title = $expData[2];
					$product_image = $expData[3];
					$product_price = $expData[4];
					$product_qty = $expData[5];
					$cat_title = $expData[6];
					$brand_title = $expData[7];
			?>
			<tr>
				<td><?=$Kategori;?></td>
				<td><?=$product_title;?></td>
				<td><img width="60" height="60" src="../product_images/<?=$product_image;?>" alt=""></td>
				<td><?=$product_price;?></td>
				<td><?=$product_qty;?></td>
				<td><?=$cat_title;?></td>
				<td><?=$brand_title ;?></td>
				<td><a class="btn btn-sm btn-info edit-product" style="color:#fff;"><span style="display:none;"></span><i class="fas fa-pencil-alt"></i></a>&nbsp;<a class="btn btn-sm btn-danger delete-product" style="color:#fff;"><i class="fas fa-trash-alt"></i></a></td>
			</tr>
